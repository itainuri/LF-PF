...
def update_apf_torch(opt, args, nn3, mm, sm, device):
    ...
    nn3_out = nn3(torch.cat((nn3_scaled_locations.view((batch_size, nof_parts, nof_targs * int(state_vector_dim / 2))), torch.unsqueeze(new_ln_weights_targs_nn3_in, -1)), -1))
    ...
    return new_prts_locs_post_nn3, new_prts_vels, ln_final_weights, parents_indces,(iteration_time, nn3_time_counter, measure_time_counter)
